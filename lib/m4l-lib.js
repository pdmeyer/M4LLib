...
class M4LLib {
     ...
     * @returns {Array} An array of [id, name] pairs
     */
    ...
    static createNewEmptyMidiClip(length, clipSlotId) {
        post('length is: ' + length + '\n');
        const methodName = 'M4LLib.createNewEmptyMidiClip';
        let clipSlot = null;
        let clip = null;
        
        try {
            post('clipSlotId is: ' + clipSlotId + '\n');
